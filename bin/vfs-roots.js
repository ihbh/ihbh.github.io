define(["require", "exports", "./prop"], function (require, exports, prop_1) {
    ...
    exports.default = {
        ...
        '/logs': pfsmod(() => new Promise((resolve_5, reject_5) => { require(['./vfs-logs'], resolve_5, reject_5); }).then(m => m.default)),
        '/sw': pfsmod(() => new Promise((resolve_6, reject_6) => { require(['./vfs-sw'], resolve_6, reject_6); }).then(m => m.default)),
    };
});
