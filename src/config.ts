...
export const RSYNC_DIR_DATA = '/idb/user/data/shared';
export const RSYNC_UNSYNCED = '/idb/user/data/rsync/unsynced';
export const RSYNC_FAILED = '/idb/user/data/rsync/failed';
